...
class Categories(models.Model):
    category_id = models.CharField(primary_key=True, max_length=6)
...
class Customers(models.Model):
    ...
    cus_name = models.CharField(max_length=100, blank=True, null=True)
    cus_phone = models.CharField(unique=True, max_length=20)
    cus_email = models.CharField(max_length=100, blank=True, null=True)
...
class Ingredients(models.Model):
    ingredient_id = models.CharField(primary_key=True, max_length=6)
    ...
    ingredirent_status = models.CharField(max_length=20, blank=True, null=True)
